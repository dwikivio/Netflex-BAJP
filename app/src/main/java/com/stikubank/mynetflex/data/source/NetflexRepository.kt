package com.stikubank.mynetflex.data.source
...
class NetflexRepository(private val remoteDataSource: RemoteDataSource): NetflexDataSource{

    companion object{
        @Volatile
        private var instance: NetflexRepository? = null

        fun getInstance(remoteData: RemoteDataSource): NetflexRepository =
            instance ?: synchronized(this) {
                instance ?: NetflexRepository(remoteData).apply { instance = this }
            }
    }
